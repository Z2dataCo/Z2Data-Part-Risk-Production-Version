...
public class AE_2_Fun_Check_Smelters_Report {
    ...
    @Parameters("Environment")
    @Test(description = "TS001 || Check Conflict Minerals Reports : Smelters Reports & Exporting As Excel", priority = 1)
    public void Check_Smelters_Report(String Environment) {
