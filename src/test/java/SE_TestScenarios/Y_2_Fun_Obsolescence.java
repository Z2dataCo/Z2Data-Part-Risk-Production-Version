...
public class Y_2_Fun_Obsolescence {
    ...
    @Test(description = "Check that side panel of High Lifecycle Risk Parts link shows high risk part && Count Table in All Tabs", priority = 2)
    ...
    @Test(description = "Check that side panel of Obsolete Parts in 3 Years shows parts that have forecast up to 3 years", priority = 3)
    ...
    @Test(description = "Check that side panel of Obsolete Part Forecast in 5 Years shows parts that have forecast up to 5 years" , priority = 4)
